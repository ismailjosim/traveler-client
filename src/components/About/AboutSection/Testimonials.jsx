    ...
    const contents = [
        {
            name: "person",
            post: "occupation",
            details: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Error corrupti nesciunt veritatis, omnis deleniti consequatur ipsum itaque ullam adipisci sequi."
        },
        {
            name: "person",
            post: "occupation",
                            ...
                            contents.map((content, idx) => {
                                ...
                                return <div key={idx} className="">
                                    <div className='flex items-center gap-5'>
                                        ...
                                        <div>
                                            <h3 className='text-2xl font-semibold uppercase text-primary'>{name}</h3>
                                            <p>{post}</p>
                                        </div>
                                    </div>
