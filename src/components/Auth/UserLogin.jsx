            ...
            <div className="flex flex-col items-center justify-center">
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <div>
                        ...
                        <input aria-label="enter email address" placeholder='Your Email' type="email" className="bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2" />
                    </div>
                    <div className="mt-2 w-full">
                        <label className="text-sm font-medium leading-none text-gray-800">Password</label>
                        <div className="relative flex items-center justify-center">
                            <input aria-label="enter Password" placeholder='Your Password' type="password" className="bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2" />
