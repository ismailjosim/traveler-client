            ...
            <div className="flex flex-col items-center justify-center">
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <div>
                        ...
                        <input placeholder='Username' type="text" className="bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2" />
                    </div>
                    <div className='mt-2'>
                        <label className="text-sm font-medium leading-none text-gray-800">Email</label>
                        <input placeholder='Your Email' type="text" className="bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2" />
                    </div>
                    <div className="mt-2 w-full">
                        <label className="text-sm font-medium leading-none text-gray-800">Password</label>
                        <div className="relative flex items-center justify-center">
                            <input placeholder='Your Password' type="password" className="bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2" />
                        </div>
                    </div>
                    <div className="mt-2 w-full">
                        <label className="text-sm font-medium leading-none text-gray-800">Confirm Password</label>
                        <div className="relative flex items-center justify-center">
                            <input placeholder='Confirm Password' type="password" className="bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2" />
                        </div>
                    </div>

                    <div className="mt-8">
                        <button className="btn-custom btn btn-primary px-5 py-1 text-base relative z-10 text-white btn-custom font-semibold w-full"> Log in</button>
                    </div>
                    <p className="text-sm mt-4 font-medium leading-none text-gray-500">Already have an account?
                        <Link className='text-sm font-medium leading-none underline text-gray-800 cursor-pointer' to='/login'> Login Here</Link>
                    </p>
                </div>
            </div>
        </div>
