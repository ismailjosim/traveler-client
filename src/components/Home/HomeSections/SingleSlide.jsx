...
const SingleSlide = ({ slide }) => {
	const { id, picture, subHeading, heading, description, btnText, prev, next } =
		slide
	return (
			...
			>
				...
				<div className='hero-content text-center text-neutral-content'>
					...
					<div className='absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2'>
						<a
							href={`#slide${prev}`}
							className='btn btn-circle border-transparent text-white text-lg bg-primary hover:bg-accent'
						>
							<BsFillCaretLeftFill />
						</a>
						<a
