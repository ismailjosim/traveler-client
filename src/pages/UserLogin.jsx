        ...
        <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16'>
          ...
          <div>
            ...
            <input
              ...
              type='email'
              className='bg-white border-2 rounded focus:outline-none focus:border-primary focus:text-primary text-base font-medium leading-none text-black py-3 w-full pl-3 mt-2'
            />
          </div>
